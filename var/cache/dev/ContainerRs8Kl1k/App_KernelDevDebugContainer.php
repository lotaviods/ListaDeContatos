...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\ContatosController' => 'getContatosControllerService',
            'App\\Controller\\ControllerHtml' => 'getControllerHtmlService',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['App\\Helper\\LidadorDeErros'] ?? $this->load('getLidadorDeErrosService'));
        }, 1 => 'handle404Exception'], -1);
